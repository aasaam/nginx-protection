...
func TestHTTPChallenge(t *testing.T) {
	...
	rsa, _ := LoadPrivateKey([]byte(pv12))
	...
	req1.Header.Set(HTTPRequestHeaderConfigChallenge, ChallengeTypeJS)
	req1.Header.Set(HTTPRequestHeaderConfigWait, "5")
	req1.Header.Set(HTTPRequestHeaderConfigTimeout, "300")
	req1.Header.Set(HTTPRequestHeaderConfigLang, "fa")
	...
	req2.Header.Set(HTTPRequestHeaderConfigWait, "5")
	req2.Header.Set(HTTPRequestHeaderConfigTimeout, "300")
	...
	req3 := httptest.NewRequest("GET", "/.well-known/protection/challenge", nil)
	req3.Header.Set(HTTPRequestHeaderConfigCookie, cookieName)
	req3.Header.Set(HTTPRequestHeaderConfigChallenge, ChallengeTypeJS)
	req3.Header.Set(HTTPRequestHeaderConfigTimeout, "300")
	req3.Header.Set(HTTPRequestHeaderConfigLang, "fa")
	req3.Header.Set(HTTPRequestXForwardedFor, "1.1.1.1")
	req3.Header.Set(HTTPRequestHeaderClientCountry, "CN")
	req3.Header.Set(HTTPRequestHeaderClientASNNumber, "11223")
	req3.Header.Set(HTTPRequestHeaderClientASNOrganization, asnOrg)
	req3.Header.Set(HTTPRequestHeaderACLAPIKeys, aclAPIKeys)
	...
	req4 := httptest.NewRequest("GET", "/.well-known/protection/challenge", nil)
	req4.Header.Set(HTTPRequestHeaderConfigCookie, cookieName)
	req4.Header.Set(HTTPRequestHeaderConfigChallenge, ChallengeTypeJS)
	req4.Header.Set(HTTPRequestHeaderConfigWait, "5")
	req4.Header.Set(HTTPRequestHeaderConfigLang, "fa")
	req4.Header.Set(HTTPRequestXForwardedFor, "1.1.1.1")
	req4.Header.Set(HTTPRequestHeaderClientCountry, "CN")
	req4.Header.Set(HTTPRequestHeaderClientASNNumber, "11223")
	req4.Header.Set(HTTPRequestHeaderClientASNOrganization, asnOrg)
	req4.Header.Set(HTTPRequestHeaderACLAPIKeys, aclAPIKeys)
	...
	req5 := httptest.NewRequest("GET", "/.well-known/protection/challenge", nil)
	req5.Header.Set(HTTPRequestHeaderConfigCookie, cookieName)
	req5.Header.Set(HTTPRequestHeaderConfigChallenge, ChallengeTypeJS)
	req5.Header.Set(HTTPRequestHeaderConfigWait, "5")
	req5.Header.Set(HTTPRequestHeaderConfigTimeout, "300")
	req5.Header.Set(HTTPRequestXForwardedFor, "1.1.1.1")
	req5.Header.Set(HTTPRequestHeaderClientCountry, "CN")
	req5.Header.Set(HTTPRequestHeaderClientASNNumber, "11223")
	req5.Header.Set(HTTPRequestHeaderClientASNOrganization, asnOrg)
	req5.Header.Set(HTTPRequestHeaderACLAPIKeys, aclAPIKeys)
